...
BEGIN
  ...
  -- Block dangerous keywords (expanded)
  ...
  -- Execute with statement_timeout and read-only guard
  BEGIN
...
JOIN public.subjects s ON s.name = d.subj_name AND s.grade = '11-A'
WHERE c.name = '11-A';

-- ─────────────────────────────────────────────────────────────────────
-- STEP 12: Sample Grades
-- ─────────────────────────────────────────────────────────────────────
